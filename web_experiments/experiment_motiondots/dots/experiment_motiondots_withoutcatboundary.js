...
var slider=function(){
  ...
  $("#slider").css("left","0%");  //reset position for slidebar...
      /*if (context=='COLOUR'){
        document.getElementById('leftofslider_text').innerHTML="blue"; 
        document.getElementById('rightofslider_text').innerHTML="red";
    ...
    console.log('here')
      ...
      /*pushing a new snowflake to the flakes array*/
        function addFlake(){
          ...
          flakes.push({"x":x,"y":y,"s":s,"rc":rc, "rb":rb, "rot":rot, "ang":ang, @ext});
        }; /*for addFlake*/
...
var outcome=function(response){
	...
	$.get("?response="+response+"&rt="+RT+"&currenttrial="+currenttrial_t+"&slider_position_subjectresponse=" +sliderposition_tmp +"&slider_position_subjectresponse_array="+slideposition_array + "&speed_eachdot=" +speed_eachdot + "&colour_eachdot=" +colour_eachdot+ "&true_outcome_colour=" +outcome_position_colour_tmp+ "&true_outcome_speed=" +outcome_position_speed_tmp +  "&context_thistrial=" + context + "&trialstart="+startTrialTime, function(response){});
