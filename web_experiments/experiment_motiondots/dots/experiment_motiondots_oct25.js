...
function Positions_outcomebar(){
    ...
    var outcomebarshow_duration=2500; //using-how long to show the outcome bar for...
...
function RunSummaryInstruct(event){
  ...
  if (eventt.indexOf('beforetrainingtrial_instruct')==0){
      document.getElementById('instruct').innerHTML='<p>placeholder</p>'
...
// function fullscreen() {
//     var element = document.getElementById("containing_container");
//     if (element.requestFullScreen) {
