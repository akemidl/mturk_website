...
var num_block1trials=0; //category boundary block trials...
var num_probetrials=0; //probe trials- slider but without feedback...
...
var event_array=[];
  ...
  for (i=0;i<num_slidertrainingtrials;i++){
      var event_array=event_array.concat('trainingtrial-'+i.toString())
        if(i % 5 ==0){ //this is saying that if the remainder of i/5 is 0
