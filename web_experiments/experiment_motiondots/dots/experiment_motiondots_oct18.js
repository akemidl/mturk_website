...
/////////////////////////////////////////////////////////////////////////////////////////////
          ...
          if (canRespondbuttons==true && e.keyCode==39) { //39 is the keycode for right arrow press, need to put in instructions...
              ...
              var T3=setTimeout(function(){
                document.getElementById("right_choice").style.height="80px";document.getElementById("right_choice").style.width="30%";
                document.getElementById("circle_container").style.width="0%";
                },squareflashtime);
            ...
            //Put the one they chose back to normal size
            var T3=setTimeout(function(){
              document.getElementById("left_choice").style.height="80px";document.getElementById("left_choice").style.width="30%";
              document.getElementById("circle_container").style.width="0%";
              },squareflashtime);
