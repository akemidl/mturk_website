...
urlpatterns = patterns("",
    ...
    url(r"^experiment_ambicombined_est/$", exp_page_ambi_combined_est),
    ...
    url(r"^experiment_beliefupdate_(?P<session>\w{0,50})/$",exp_page_beliefupdate),
    url(r"^experiment_questionnaires_(?P<survey_name>\w{0,50})/$",exp_page_questionnaires),
    url(r"^experiment_effort/$",exp_page_effort),
    url(r"^experiment_planning/$",exp_page_planning),
