...
/*This is the js for running the experiment, made using jsPsych*/
...
var welcome_block={
  type: "text",
  text: "Welcome to the expt. Please press any key to continue",
};
...
/*Look at how Chris loads the conditions from a text file...*/
var condition=[
  {
    type:"text",
    text: "speed",
